...
# Import target "cryptopp-shared" for configuration "Debug"
set_property(TARGET cryptopp-shared APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(cryptopp-shared PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/cryptopp-shared.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "kernel32"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/cryptopp-shared.dll"
  )
...
set_target_properties(cryptopp-static PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "kernel32"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/cryptopp-static.lib"
  )
