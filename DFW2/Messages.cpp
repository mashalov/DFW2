...
const char* CDFW2Messages::m_cszUserModelAlreadyCompiled = "Повторная компиляции не требуется";
const char* CDFW2Messages::m_cszUserModelShouldBeCompiled = "Необходима компиляция";
