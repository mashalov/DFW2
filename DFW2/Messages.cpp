...
const char* CDFW2Messages::m_cszLRCSmoothingTooBigFor = "Для СХН {} \"{}\" параметр cглаживания {} слишком велик и будет ограничен значением {}";
...
const char* CDFW2Messages::m_cszIslandSlackBusesCount = "Синхронная зона содержит {} включенных узлов, из них базисных узлов {}. Угол {}";
...
const char* CDFW2Messages::m_cszDLLFunctionNotFound = "Функция \"{}\" не найдена в DLL \"{}\"";
const char* CDFW2Messages::m_cszDLLIsNotReadyForCreateCall = "DLL is not ready for Create call";
...
const char* CDFW2Messages::m_cszTooManyCachedModules = "Количество или общий размер кэшированных модулей {}/{:.1f} Мб превышают заданные ограничения {}/{} Мб в каталоге \"{}\"";
const char* CDFW2Messages::m_cszNextCacheClieanIn = "Следующая очистка кэша модулей \"{}\" будет выполнена при запуске через {} с";
const char* CDFW2Messages::m_cszRemovingExcessCachedModule = "Удаление устаревшего файла кэшированной модели \"{}\"";
const char* CDFW2Messages::m_cszUserModelFailedToOpenSource = "Ошибка доступа к файлу пользовательской модели \"{}\"";
const char* CDFW2Messages::m_cszUserModelAlreadyCompiled = "Рекомпиляции не требуется";
const char* CDFW2Messages::m_cszCachedUserModelFound = "Модуль пользовательской модели найден по хэшу исходного текста";
const char* CDFW2Messages::m_cszUserModelShouldBeCompiled = "Необходима рекомпиляция";
const char* CDFW2Messages::m_cszCustomModelModule = "Модуль пользовательской модели \"{}\"";
const char* CDFW2Messages::m_cszCustomModelHasNoMetadata = "не содержит метаданных";
const char* CDFW2Messages::m_cszCustomModelChanged = "описание модели изменено";
const char* CDFW2Messages::m_cszCompilerVersionMismatch = "собран компилятором версии {}. Текущая версия компилятора {}";
