...
const _TCHAR* CDFW2Messages::m_cszSwitchedOffBranch = _T("%s %s отключена %s так как узел %s отключен");
...
const _TCHAR* CDFW2Messages::m_cszNodeShutDownAsNotLinkedToSlack = _T("Узел %s отключен так как находится в зоне, не содержащей базисного узла");
...
const _TCHAR* CDFW2Messages::m_cszTurningOffDeviceDueToNoMasterDevice = _T("Устройство \"%s\" отключено, так как не найдено связанное ведущее устройство");
