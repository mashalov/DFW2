...
void CLoadFlow::CompareWithRastr()
{
	...
	m_pDynaModel->Log(CDFW2Messages::DFW2LOG_DEBUG, "Rastr differences");
	m_pDynaModel->Log(CDFW2Messages::DFW2LOG_DEBUG, fmt::format("V     {} {}", pNodeMaxV->V - pNodeMaxV->Vrastr, pNodeMaxV->GetVerbalName()));
	m_pDynaModel->Log(CDFW2Messages::DFW2LOG_DEBUG, fmt::format("Delta {} {}", pNodeMaxDelta->Delta - pNodeMaxDelta->Deltarastr, pNodeMaxDelta->GetVerbalName()));
	m_pDynaModel->Log(CDFW2Messages::DFW2LOG_DEBUG, fmt::format("Qg    {} {}", pNodeMaxQg->Qg - pNodeMaxQg->Qgrastr, pNodeMaxQg->GetVerbalName()));
	m_pDynaModel->Log(CDFW2Messages::DFW2LOG_DEBUG, fmt::format("Pnr   {} {}", pNodeMaxPnr->Pnr - pNodeMaxPnr->Pnrrastr, pNodeMaxPnr->GetVerbalName()));
	m_pDynaModel->Log(CDFW2Messages::DFW2LOG_DEBUG, fmt::format("Qnr   {} {}", pNodeMaxQnr->Qnr - pNodeMaxQnr->Qnrrastr, pNodeMaxQnr->GetVerbalName()));
	fclose(s);
}
#endif
