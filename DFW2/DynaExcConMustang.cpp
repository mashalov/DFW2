...
void CDynaExcConMustang::UpdateSerializer(CSerializerBase* Serializer)
{
	...
	Serializer->AddState(cszUsumLmt_, UsumLmt, eVARUNITS::VARUNIT_PU);
...
void CDynaExcConMustang::DeviceProperties(CDeviceContainerProperties& props)
{
	...
	props.VarMap_.insert(std::make_pair(cszUsumLmt_, CVarIndex(CDynaExcConMustang::V_USUMLMT, VARUNIT_PU)));
