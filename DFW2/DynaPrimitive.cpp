...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// 	Здесь есть проблема: мы получаем от примитива A шаг, удовлетворяющий ZeroCrossingStepReached
//  и меняем его состояние. Но при этом следующий примтив B дает меньший rH и шаг делается меньше, чем
//  то на которм A должен изменить состояние ! Возможный вариант - сделать полный проход по ZeroCrossing и 
//  менять состояния только после того как станет известен наименьший rH !
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
