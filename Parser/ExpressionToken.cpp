...
void CExpressionToken::GetEquationOperandIndex(const CCompilerEquation *pEquation, wstring& Result) const
{
	VariableEnum *pEnum;
...
int CExpressionToken::Compare(const CExpressionToken *pToCompare) const
{
	int nIdentical = 0;
