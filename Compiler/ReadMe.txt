========================================================================
    ACTIVE TEMPLATE LIBRARY : Compiler Project Overview
========================================================================

AppWizard has created this Compiler project for you to use as the starting point for
...
Compiler.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Compiler.h)
        GUID definitions                                (Compiler_i.c)
        A type library                                  (Compiler.tlb)
        Marshaling code                                 (Compiler_p.c and dlldata.c)

Compiler.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Compiler.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named Compiler.pch and a precompiled types file named StdAfx.obj.
...
Compilerps.vcxproj
	...
	dlldata.c, Compiler_i.c and Compiler_p.c which are required
	to build the proxy/stub DLL.

Compilerps.vcxproj.filters
