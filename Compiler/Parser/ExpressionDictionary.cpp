...
FunctionEnum CParserDefaultDictionary::DefaultFunctions[22] = {
	...
	FunctionEnum(ETT_RELAYAL,	_T("alrelay"),	   -1, &TransRelayDelayLogic),
...
CTransformRelayDelayLogic	CParserDefaultDictionary::TransRelayDelayLogic;
