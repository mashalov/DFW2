...
%, and the comparison of integration steps is shown in Fig.~\ref{case2step}.
...
%\begin{figure}[htbp]
%	\centering
%	\includegraphics[width=.8\columnwidth]{case2step.eps}
...
%\begin{figure}[htbp]
%	\centering
%	\includegraphics[width=.8\columnwidth]{case2atolsstep.eps}
%	\caption{Comparison of integration step with different tolerances for case 2}
%	\label{case2atolsstep}
%\end{figure}
